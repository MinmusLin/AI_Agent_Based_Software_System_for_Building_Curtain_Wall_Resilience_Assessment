...
上述需求分析为\cref{chap:design}技术方案设计和\cref{chap:implementation}系统架构与工程实现提供了明确依据。\cref{chap:design}将重点回答如何设计受控 Agent 调度和分层信息整合方法，\cref{chap:implementation}则进一步说明这些需求如何落地为服务架构、协议、数据库状态机、对象存储和前端可视化实现。
