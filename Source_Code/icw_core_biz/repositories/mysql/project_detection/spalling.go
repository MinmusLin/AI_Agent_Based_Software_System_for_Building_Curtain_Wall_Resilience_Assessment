...
func createProjectDetectionSpallingTaskTx(ctx context.Context, tx *sql.Tx, task *mysql.ProjectDetectionTaskRecord) (*mysql.ProjectDetectionSubTaskRecord, error) {
...
func findProjectDetectionSpallingTaskByUuidTx(ctx context.Context, tx *sql.Tx, taskUuid string) (*mysql.ProjectDetectionSubTaskRecord, error) {
