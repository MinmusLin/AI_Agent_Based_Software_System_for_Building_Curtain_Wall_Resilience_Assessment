...
type Config struct {
	...
	MinIODirtyObjectCleanupJobCron string        `env:"MINIO_DIRTY_OBJECT_CLEANUP_JOB_CRON"`
...
func (cfg *Config) Validate() error {
	...
	required := []struct {
		...
		{key: "MINIO_DIRTY_OBJECT_CLEANUP_JOB_CRON", value: cfg.MinIODirtyObjectCleanupJobCron},
	}
...
func Load() (Config, error) {
	cfg := Config{
		...
		MinIODirtyObjectCleanupJobCron: env.EnvString("MINIO_DIRTY_OBJECT_CLEANUP_JOB_CRON"),
