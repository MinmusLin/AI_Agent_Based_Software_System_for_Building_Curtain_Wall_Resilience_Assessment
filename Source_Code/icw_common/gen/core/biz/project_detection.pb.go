...
type GetImageDetectionResultResponse struct {
	...
	TaskCodes       []common.DetectionTaskCode_Value        `protobuf:"varint,4,rep,packed,name=task_codes,json=taskCodes,proto3,enum=icw.core.common.DetectionTaskCode_Value" json:"task_codes,omitempty"`
...
func (x *GetImageDetectionResultResponse) GetTaskCodes() []common.DetectionTaskCode_Value {
	if x != nil {
		return x.TaskCodes
	}
	return nil
...
func (x *ReportClassificationResultRequest) GetStatus() common.TaskStatus_Value {
	if x != nil {
		return x.Status
	}
...
func (x *ReportClassificationResultRequest) GetTaskCodes() []common.DetectionTaskCode_Value {
	if x != nil {
		return x.TaskCodes
	}
	return nil
...
func (x *ReportDetectionSummaryResultRequest) GetStatus() common.TaskStatus_Value {
	if x != nil {
		return x.Status
	}
	return common.TaskStatus_Value(0)
...
type ReportReasoningResultRequest struct {
	state         protoimpl.MessageState           `protogen:"open.v1"`
	TaskCode      common.DetectionTaskCode_Value   `protobuf:"varint,1,opt,name=task_code,json=taskCode,proto3,enum=icw.core.common.DetectionTaskCode_Value" json:"task_code,omitempty"`
	TaskUuid      string                           `protobuf:"bytes,2,opt,name=task_uuid,json=taskUuid,proto3" json:"task_uuid,omitempty"`
	ImageUuid     string                           `protobuf:"bytes,3,opt,name=image_uuid,json=imageUuid,proto3" json:"image_uuid,omitempty"`
	Status        common.TaskStatus_Value          `protobuf:"varint,4,opt,name=status,proto3,enum=icw.core.common.TaskStatus_Value" json:"status,omitempty"`
...
func (x *ReportReasoningResultRequest) GetStatus() common.TaskStatus_Value {
	if x != nil {
		return x.Status
	}
	return common.TaskStatus_Value(0)
...
const file_core_biz_project_detection_proto_rawDesc = "" +
	"\n" +
	" core/biz/project_detection.proto\x12\ficw.core.biz\x1a\x15core/biz/common.proto\x1a\x11core/common.proto\"w\n" +
	...
	"\n" +
	"image_uuid\x18\x03 \x01(\tR\timageUuid\"\x8d\x06\n" +
	...
	"\x06status\x18\x03 \x01(\v2'.icw.core.common.ProjectDetectionStatusR\x06status\x12G\n" +
	"\n" +
	...
	"\x06status\x18\x03 \x01(\x0e2!.icw.core.common.TaskStatus.ValueR\x06status\x12G\n" +
	"\n" +
	"task_codes\x18\x04 \x03(\x0e2(.icw.core.common.DetectionTaskCode.ValueR\ttaskCodes\x12#\n" +
	...
	"\ttask_code\x18\x01 \x01(\x0e2(.icw.core.common.DetectionTaskCode.ValueR\btaskCode\x12\x1b\n" +
	"\ttask_uuid\x18\x02 \x01(\tR\btaskUuid\x12\x1d\n" +
	"\n" +
	"image_uuid\x18\x03 \x01(\tR\timageUuid\x129\n" +
	"\x06status\x18\x04 \x01(\x0e2!.icw.core.common.TaskStatus.ValueR\x06status\x12\x1f\n" +
