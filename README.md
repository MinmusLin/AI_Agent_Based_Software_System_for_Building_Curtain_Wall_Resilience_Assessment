...
> [!TIP]
> For more details, please refer to the [*Design and Implementation of an AI Agent-Based Software System for Building Curtain Wall Resilience*](Documentations/毕业设计（论文）单面版.pdf) (115 pages, 13.9 MB)
>
> 有关更多详细信息，请参考[《基于 AI Agent 的建筑幕墙韧性评估软件系统设计与实现》](Documentations/毕业设计（论文）单面版.pdf)（115 页，13.9 MB）
>
> <p align="center">
>   <img src="assets/Information.png" width="30%">
